...
const AboutMe = (props) => {
  return (
    <div className={styles.intro}>
      ...
      <p>Formerly, I was an ABA Certificated Paralegal working in the Emerging Companies, Debt Financing, and Corporate Law fields. Presently volunteering as a Crisis Counselor at Crisis Text Line.</p>
